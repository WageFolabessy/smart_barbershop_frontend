...
export default function BarberRecordsPage() {
    ...
    const [deletingRecord, setDeletingRecord] = useState<HairRecord | null>(
        null
    )
    ...
    >({
        ...
        queryFn: async () => {
            const res = await api.get<{ data: HairRecord[] }>(
                '/api/hair-records'
            )
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">
                    Kelola hasil cukur yang telah diupload.
                </p>
            </div>
                                                        ...
                                                        <DialogTrigger asChild>
                                                            <div className="relative h-full w-full cursor-pointer">
                                                                <Image
                                                                    ...
                                                                    unoptimized
                                                                />
                                                                <div className="absolute right-0 bottom-0 left-0 bg-black/60 p-1 text-center text-[10px] text-white">
                                                                    Before
                                                                </div>
                                                            </div>
                                                        </DialogTrigger>
                    ...
                    <form onSubmit={handleEditSubmit} className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="edit-before">
                                    Foto Before (Opsional)
                                </Label>
                                <Input
                                    id="edit-before"
                                    name="photo_before"
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="edit-hair_type"
                                name="hair_type"
                                defaultValue={editingRecord?.hair_type || ''}
                                placeholder="Contoh: Ikal, Lurus, Berminyak"
                            />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="edit-scalp_condition">
                                Kondisi Kulit Kepala
                            </Label>
                            <Input
                                id="edit-scalp_condition"
                                name="scalp_condition"
                                defaultValue={
                                    editingRecord?.scalp_condition || ''
                                }
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                defaultValue={
                                    editingRecord?.treatment_notes || ''
                                }
                                placeholder="Catatan teknis cukuran..."
                            />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="edit-recommendations">
                            ...
                            <Textarea
                                ...
                                defaultValue={
                                    editingRecord?.barber_recommendations || ''
                                }
            ...
            <AlertDialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Tindakan ini tidak dapat dibatalkan. Data riwayat
                            cukur ini akan dihapus permanen.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
