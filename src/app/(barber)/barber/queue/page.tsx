...
export default function BarberQueuePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-primary">Antrian Hari Ini</h1>
        <p className="text-muted-foreground">Kelola booking yang berlangsung hari ini.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>
            Antrian ({format(today, "eeee, d MMMM yyyy", { locale: id })})
          </CardTitle>
        </CardHeader>
        <CardContent>
          {isLoadingBookings ? (
            ...
            <div className="text-center py-12 text-muted-foreground">Tidak ada jadwal untuk hari ini.</div>
          ) : (
