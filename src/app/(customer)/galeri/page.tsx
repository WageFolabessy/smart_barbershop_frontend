        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">
                    Koleksi transformasi gaya rambut Anda.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                {records?.map((record, idx) => (
                    <Card
                        key={record.id}
                        className="group hover:border-primary overflow-hidden transition-colors"
                    >
                        <CardHeader className="p-4 pb-2">
                            <div className="flex items-start justify-between">
                                <div>
                                    <CardTitle className="text-lg">
                                        {record.hair_type || 'Gaya Rambut'}
                                    </CardTitle>
                                ...
                                {record.photos?.before && (
                                    <Dialog>
                                        <DialogTrigger asChild>
                                            <div className="bg-muted relative aspect-square cursor-pointer overflow-hidden rounded-md">
                                                <Image
                                                    src={assetUrl(
                                                        record.photos.before
                                                    )}
                                        ...
                                        <DialogContent className="max-w-3xl overflow-hidden bg-black p-0">
                                            ...
                                            <Image
                                                ...
                                                alt="Before transformation - full view"
                                                width={1200}
                                                height={1200}
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent className="max-w-3xl overflow-hidden bg-black p-0">
                                            ...
                                            <Image
                                                ...
                                                alt="After transformation - full view"
                                                width={1200}
                                                height={1200}
                                                className="h-auto w-full"
                                                loading="lazy"
            ...
            {records?.length === 0 && (
                <div className="text-muted-foreground rounded-lg border-2 border-dashed py-12 text-center">
                    ...
                    <p className="text-sm">
                        Selesaikan booking pertama Anda untuk melihat galeri
                        ini.
                    </p>
                </div>
            )}
